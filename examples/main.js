...
var _pairshaped$elm_firebase$Firebase$app = _pairshaped$elm_firebase$Native_Firebase.app;
var _pairshaped$elm_firebase$Firebase$apps = _pairshaped$elm_firebase$Native_Firebase.apps;
var _pairshaped$elm_firebase$Firebase$getAppByName = function (appName) {
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$filter,
			function (app) {
				return _elm_lang$core$Native_Utils.eq(
					_pairshaped$elm_firebase$Firebase$name(app),
					appName);
			},
			_pairshaped$elm_firebase$Firebase$apps(
				{ctor: '_Tuple0'})));
};
var _pairshaped$elm_firebase$Firebase$sdkVersion = _pairshaped$elm_firebase$Native_Firebase.sdkVersion;
var _pairshaped$elm_firebase$Firebase$Config = F6(
	function (a, b, c, d, e, f) {
		return {apiKey: a, authDomain: b, databaseURL: c, storageBucket: d, messagingSenderId: e, projectId: f};
	});
...
var _user$project$Data$decodeData = F2(
	function (d, v) {
		return A2(_elm_lang$core$Json_Decode$decodeValue, d, v);
	});
var _user$project$Data$decode = F2(
	function (d, v) {
		var _p0 = A2(_user$project$Data$decodeData, d, v);
		if (_p0.ctor === 'Ok') {
			return _elm_lang$core$Maybe$Just(_p0._0);
		} else {
			return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Data$encodeData = function (c) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _user$project$Data$dataDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
...
var _user$project$Data$createFDictConfig = F3(
	function (path, get, set) {
		return {path: path, encoder: _user$project$Data$encodeData, decoder: _user$project$Data$dataDecoder, get: get, set: set};
	});
		...
		if (_p1.ctor === 'Time') {
			...
			var value = A2(
				...
				A2(
					...
					config.decoder,
					_pairshaped$elm_firebase$Firebase_Database_Snapshot$value(_p4)));
			var _p3 = value;
			if (_p3.ctor === 'Err') {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			} else {
...
var _user$project$FirebaseDict$subscribeFDict = F2(
	function (tagger, db) {
		var fooRef = A2(
		...
		return _elm_lang$core$Platform_Sub$batch(
			{
				...
				_0: A2(
					_elm_lang$core$Time$every,
					_elm_lang$core$Time$second * 4,
					function (time) {
						return tagger(
							_user$project$FirebaseDict$Time(time));
					}),
				_1: {
					ctor: '::',
					_0: A3(
...
var _user$project$Model$initModel = function () {
	...
	return {mdl: _debois$elm_mdl$Material$model, app: app, db: db, onText: 'init', config: _user$project$Data$empty, fooDict: _user$project$FirebaseDict$empty};
}();
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {mdl: a, app: b, db: c, onText: d, config: e, fooDict: f};
	});
var _user$project$Model$HeartBit = function (a) {
	return {ctor: 'HeartBit', _0: a};
};
var _user$project$Model$WriteStatus = function (a) {
	return {ctor: 'WriteStatus', _0: a};
};
var _user$project$Model$ChangeIntMsg = function (a) {
	return {ctor: 'ChangeIntMsg', _0: a};
};
var _user$project$Model$ChangeStringMsg = function (a) {
	return {ctor: 'ChangeStringMsg', _0: a};
};
var _user$project$Model$MyToggleMsg = {ctor: 'MyToggleMsg'};
var _user$project$Model$Get = {ctor: 'Get'};
var _user$project$Model$Set = {ctor: 'Set'};
var _user$project$Model$Push = {ctor: 'Push'};
var _user$project$Model$FooValue = function (a) {
...
var _user$project$View$renderConfig = function (model) {
	return A2(
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A5(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onToggle(_user$project$Model$MyToggleMsg),
									_1: {
										ctor: '::',
									...
									model.mdl,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onInput(_user$project$Model$ChangeStringMsg),
													_1: {ctor: '[]'}
												}
											}
										}
										...
										model.mdl,
										{
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onInput(_user$project$Model$ChangeIntMsg),
														_1: {ctor: '[]'}
													}
												}
											}
		...
		},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$View$renderConfig(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$View$button1 = function (model) {
	return A5(
		_debois$elm_mdl$Material_Button$render,
		_user$project$Model$Mdl,
		{
...
var _user$project$View$drawer = function (model) {
	return {
		ctor: '::',
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$View$button1(model),
					_1: {ctor: '[]'}
				}
			}),
		_1: {
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: A3(_pairshaped$elm_firebase$Firebase_Database_Reference$on, 'child_added', fooRef, _user$project$Model$FooValue),
				_1: {
					ctor: '::',
					_0: A2(_user$project$FirebaseDict$subscribeFDict, _user$project$Model$HeartBit, model.db),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$view = function (model) {
	return A4(
		...
		},
		{
			...
			drawer: _user$project$View$drawer(model),
			tabs: {
				ctor: '_Tuple2',
				_0: {ctor: '[]'},
				_1: {ctor: '[]'}
...
var _user$project$Main$dataConfig = A3(
	_user$project$Data$createFDictConfig,
	'foo',
	function (_) {
		return _.fooDict;
	},
		...
		switch (_p0.ctor) {
			...
			case 'FooValue':
				var value = A2(
					...
					A2(
						_elm_lang$core$Json_Decode$decodeValue,
						_user$project$Data$dataDecoder,
			...
			case 'Get':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'HeartBit':
				return A4(_user$project$FirebaseDict$update, _user$project$Model$HeartBit, _p0._0, _user$project$Main$dataConfig, model);
			case 'MyToggleMsg':
			...
			case 'Set':
				var fooRef = A2(
					...
					_elm_lang$core$Maybe$Just('foo'),
					model.db);
				var value = _user$project$Data$encodeData(model.config);
				var command = A2(
					_elm_lang$core$Task$attempt,
					_user$project$Model$WriteStatus,
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			...
			_1: _debois$elm_mdl$Material_Layout$sub0(_user$project$Model$Mdl)
		},
